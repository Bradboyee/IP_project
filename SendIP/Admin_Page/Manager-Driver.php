	...
	<body>
		<div class="wrapper">
			<div class="sidebar">
				<h2>Manager Page</h2>
				<ul>
                    <li class="active"><a href="./Manager-Driver.php"><i class='bx bxs-car'></i>Driver</a></li>
                ...
                <div class="body">
					<table id="example" class="table table-striped table-bordered table-hover table-responsive-sm" style="width:100%">
						...
						<tbody>
							...
							<tr>
								<td width="3%"><?php echo $item["Driver_ID"]; ?></td>
								<td><?php echo $item["Driver_Name"]; ?></td>
								<td><?php echo $item["Driver_Tel"]; ?></td>
								<td><?php echo $item["Driver_Address"]; ?></td>
								<td><?php echo $item["Driver_WorkPlace"]; ?></td>
								<td>**********</td>
								<td class="text-center">
									<div class="btn-group btn-group-sm">
									<center>
										<a class="btn btn-danger" href="del_driver.php?id=<?php echo $item["Driver_ID"]; ?>" onclick=\"return confirm('Do you want to delete this record? !!!')\">
