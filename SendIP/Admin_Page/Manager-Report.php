		...
		<div class="wrapper">
			<div class="sidebar">
				...
				<ul>
					...
					<li class="active"><a href="./Manager-Report.php"><i class='bx bxs-report'></i>Problem</a></li>
				</ul>
				<div class="account">
					<span>Account</span>
				</div>
                ...
                <div class="body">
					<table id="example" class="table table-striped table-bordered table-hover table-responsive-sm" style="width:100%">
						...
						<tbody>
							...
							<tr>
								<td width="5%"><?php echo $item["Problem_ID"]; ?></td>
								<td><?php echo $item["Problem_text"]; ?></td>
								<td><?php echo $item["Problem_reportDate"]; ?></td>
								<td class="text-center">
									<div class="btn-group btn-group-sm">
									<center>
										<a class="btn btn-danger" href="del_report.php?id=<?php echo $item["Problem_ID"]; ?>" onclick=\"return confirm('Do you want to delete this record? !!!')\">
