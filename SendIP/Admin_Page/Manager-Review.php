		...
		<div class="wrapper">
			<div class="sidebar">
				...
				<ul>
					...
					<li class="active"><a href="./Manager-Review.php"><i class='bx bx-message-rounded-add' ></i>Review</a></li>
                ...
                <div class="body">
					<table id="example" class="table table-striped table-bordered table-hover table-responsive-sm" style="width:100%">
						...
						<tbody>
							...
							<tr>
								<td width="10%"><?php echo $item["Review_ID"]; ?></td>
								<td><?php echo $item["Review_Score"]; ?></td>
								<td><?php echo $item["Review_Feedback"]; ?></td>
